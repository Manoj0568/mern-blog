...
export default function DashboardComp() {
  ...
  return (
    <div className='p-3 md:mx-auto'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 lg:grid-flow-col-1 gap-4 py-3 mx-auto justify-center'>
        ...
        <div className='flex flex-col lg:col-span-2 w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800'>
          <div className='flex justify-between  p-3 text-sm font-semibold'>
