    ...
    <div className='max-w-2xl mx-auto w-full p-3'>
      ...
      )}
      {
        comments.length == 0 ?(
            ...
            {
                comments.map((comment)=>{
                    return <Comment key={comment._id} comment={comment} onLike={handleLike} onEdit={handleEdit} onDelete={(commentId)=>{setShowModal(true); setCommentToDelete(commentId)}}/>
                })
               }
            </>
        )
      ...
      <Modal show={showModal} onClose={()=>setShowModal(false)} popup size='md'>
          ...
          <Modal.Body>
            <div className='text-center'>
                <HiOutlineExclamationCircle className='h-14 w-14  text-gray-500 dark:test-gray-200 mb-4 mx-auto'/>
                <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are you sure about deleting this comment?</h3>
